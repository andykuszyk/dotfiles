...
(defun ak/enable-light-theme ()
  ...
  (ak/spaceline-compile)
  (custom-set-faces
   '(org-scheduled-today ((t (:foreground "#6c4173"))))
...
(defun ak/enable-dark-theme ()
  ...
  (ak/spaceline-compile)
  (custom-set-faces
   '(org-scheduled-previously ((t (:foreground "#bc6ec5"))))
   '(org-scheduled-today ((t (:foreground "#b2b2b2"))))
...
(ak/enable-dark-theme) ; enable dark theme to apply the org face changes
#+end_src
...
(which-key-mode)
(setq which-key-idle-delay 5.0) ; only display the which-key popup after 5 seconds of indecision!
#+end_src
