...
(defun ak/center-reading ()
  (interactive)
  (visual-line-mode)
  (set-window-margins nil (ak/reading-margin) (ak/reading-margin)))

(defun ak/left-reading ()
  (interactive)
  (visual-line-mode)
  (set-window-margins nil 0 (ak/reading-margin)))

(defun ak/right-reading ()
  (interactive)
  (visual-line-mode)
  (set-window-margins nil (ak/reading-margin) 0))

(defun ak/reset-reading ()
  (interactive)
